...
import com.webgeoservices.locationnotification.SearchAPIDataModel.Feature;
import com.webgeoservices.locationnotification.SearchAPIDataModel.SearchAPI;
...
import static com.webgeoservices.locationnotification.WoosmapSettings.Tags.NotificationError;
import static com.webgeoservices.locationnotification.WoosmapSettings.getNotificationDefaultUri;
...
public class WoosmapMessageBuilderMaps {
    ...
    public void sendWoosmapNotification(final WoosmapMessageDatas datas) {
        Log.d(WoosmapSettings.Tags.WoosmapTag, "Search API");
        ...
        if (datas.timestamp != null) {
            ...
            try{
                ...
                Log.d(WoosmapSettings.Tags.WoosmapTag, "invalid timestamp ");
                return;
            }
        ...
        String CHANNEL_ID = WoosmapSettings.notificationChannelId;
        ...
        if (this.cls != null) {
            ...
            if (datas.open_uri != null){
                ...
                Log.d(WoosmapSettings.Tags.WoosmapTag, "Try to open empty URI");
        ...
        Log.d(WoosmapSettings.Tags.WoosmapTag, "notif: "+datas.notificationId);
    ...
    private void sendErrorNotification(Context context, String errorMsg) {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, WoosmapSettings.notificationChannelId)
